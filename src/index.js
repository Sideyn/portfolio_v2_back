...
// J'importe le fichier app
const app = require("./app");

// J'indique que le port à utilisé est dans le fichier .env si je tombe sur le port 5000
// c'est qu'il y a certainement un souci avec le port utilisé dans le .env
